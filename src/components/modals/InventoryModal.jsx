...
const STOCK_OPTIONS = ["Instock", "Out of Stock", "Low Stock"];
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="flex flex-col items-center gap-2">
            <div
              ...
              className="w-full h-44 rounded-xl bg-[#2a2a2a] border border-white/10 flex items-center justify-center cursor-pointer hover:border-pink-400/50 transition overflow-hidden"
            >
              {imagePreview ? (
          ...
          {/* Perishable */}
          <div>
            <label className="text-white text-sm font-medium block mb-3">Perishable</label>
